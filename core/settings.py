...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://plunicerp.plunicsolutions.com.ng",
    "https://plunicerpapi.plunicsolutions.com.ng",
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),#5 in standard, but 30 for better UX
...
INSTALLED_APPS = [
    ...
    'setup','finance','hmcs','logistics','crm'
]
...
DATABASES = {
        ...
        'OPTIONS': {'init_command': "SET sql_mode='STRICT_TRANS_TABLES', default_storage_engine=INNODB" ,"use_pure": True,},
