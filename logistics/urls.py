...
from . import views
from .views import (AgentMovementTrail, AllMyDispatchView, CreateOrderView, DispatchedOrderView, MyDispatchView, ScanItemView, OverdueItemsView, UpdateAgentLocation, UpdateDeliveryStatus, UpdateDispatcherStatusView,VendorFetchView,
                    OrderUploadPreviewView,WarehouseScanView)
from .views import (
    DispatcherListView,ValidateBarcodeView,DriverPickupUpdateView,ManifestView,
    PartnerCreateView,PartnerDetailView,DispatchSummaryView,
    BulkDispatchView,dispatcherPickupView,DriverPickupCreateView,
    SingleDispatchView,VehicleDetailView,VehicleListCreateView,OrderByStatusView,
    HubViewSet,HubTransferViewSet,HubItemDetailView,HubstoreViewSet,ValidateHubBarcodeView
)
...
urlpatterns =router.urls + [
    ...
    path("driver-pickup/create/", DriverPickupCreateView.as_view(), name="driver-pickup-create"),
