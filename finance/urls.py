...
from .views import WalletFundingViewSet,IouRequestViewSet,ExpenseViewSet
...
urlpatterns = router.urls +[
    path("customer-wallet-balance/<uuid:id>/", CustomerWalletBalance.as_view(), name="customer-wallet-balance"),
    path("customer-wallet-transactions/<uuid:id>/", WalletTransactions.as_view(), name="customer-wallet-transactions"),
